...
def load_vocabulary(vocabulary_path, tag=""):
    ...
    if vocabulary_path:
        vocabulary = []
        print("Loading {} vocabulary from {}".format(tag,
                                              vocabulary_path))
...
def build_vocab(train_dataset_files, fields, data_type, share_vocab,
    ...
    Args:
        ...
        src_vocab_path(str): Path to source vocabulary file.
        src_vocab_size(int): size of the source vocabulary.
        src_words_min_frequency(int): the minimum frequency needed to
                include a source word in the vocabulary.
        tgt_vocab_path(str): Path to target vocabulary file.
    ...
    if src_vocab is not None:
        ...
        print('Loaded source vocab has %d tokens.' % src_vocab_size)
    ...
    if tgt_vocab is not None:
        ...
        print('Loaded target vocab has %d tokens.' % tgt_vocab_size)
