...
class TextDataset(ONMTDatasetBase):
    ...
    def get_fields(n_src_features, n_tgt_features):
        ...
        fields["src_map"] = torchtext.data.Field(
            use_vocab=False, tensor_type=torch.Tensor, #tensor_type=torch.FloatTensor, #if tensor_type is None else tensor_type,
            postprocessing=make_src, sequential=False)
        #fields["src_map"] = torchtext.data.Field(
        #    use_vocab=False, tensor_type=torch.cuda.FloatTensor,
        #    postprocessing=make_src, sequential=False)
