...
class LossComputeBase(nn.Module):
    ...
    def sharded_compute_loss(self, batch, output, attns,
        ...
        """
        if "_statistics" in self.__dict__.keys() and not self._statistics is None:
            stats_class = self._statistics
            batch_stats = stats_class(self.multimodal_model_type)
        else:
